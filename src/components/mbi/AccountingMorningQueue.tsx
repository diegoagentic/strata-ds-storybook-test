 ...
 *
 * DS TOKENS: bg-card · bg-status-ai/5 · success / amber accents
 *
    ...
    return (
        <div className="bg-card dark:bg-zinc-800 border border-border rounded-2xl overflow-hidden">
            <div className="px-4 py-2.5 border-b border-border bg-muted/20 flex items-center gap-2">
                <RefreshCw className="h-4 w-4 text-status-ai" />
            ...
            <div className="px-4 py-3 flex items-center gap-3 flex-wrap">
                ...
                {stage === 'processing' && (
                    <div className="shrink-0 inline-flex items-center gap-1.5 text-[11px] text-status-ai font-bold">
                        <Loader2 className="h-3.5 w-3.5 animate-spin" />
                        {RECHECK_STEPS[Math.min(stepIdx, RECHECK_STEPS.length - 1)]}…
                    </div>
                )}
                {stage === 'done' && (
                    <div className="shrink-0 inline-flex items-center gap-1.5 text-[11px] text-status-success font-bold">
...
export default function AccountingMorningQueue() {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="bg-status-ai/5 dark:bg-status-ai/10 border border-status-ai/30 rounded-2xl p-4 flex items-start gap-3">
                <div className="h-10 w-10 rounded-xl bg-status-ai/15 text-status-ai flex items-center justify-center shrink-0">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 mt-2 flex-wrap">
                        ...
                        <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold text-status-ai">
                            <Loader2 className="h-3 w-3" />
                            {inProgress} in progress · agents
                        </span>
                        <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold text-status-success">
