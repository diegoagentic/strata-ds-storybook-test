    ...
    return (
        <div className="space-y-3">
            ...
            <div className="bg-card dark:bg-zinc-800 border border-border rounded-2xl p-4 grid grid-cols-3 gap-4">
                ...
                <div>
                    <div className="text-[10px] font-bold text-status-success uppercase tracking-wider">Auto-posted</div>
                    <div className="text-2xl font-bold text-status-success tabular-nums mt-0.5">{clean.length}</div>
...
function MismatchCard({
    ...
    if (isResolved) {
        return (
            <div className="bg-status-success/5 border border-status-success/30 rounded-2xl p-3 flex items-center gap-3">
        ...
        <div className="bg-red-50/40 dark:bg-red-500/5 border-2 border-red-300 dark:border-red-500/30 rounded-2xl p-4">
            ...
            <div className="mt-3 bg-background border border-border rounded-xl p-3">
                <div className="flex items-center gap-1.5 mb-1">
                    ...
                    <div className="text-[10px] font-bold text-status-ai uppercase tracking-wider">Strata suggests</div>
                </div>
