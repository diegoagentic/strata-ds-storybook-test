                        ...
                        return (
                            <div key={i} className={`px-4 py-2.5 flex items-start gap-3 ${theme.bg}`}>
                                ...
                                <div className="shrink-0">
                                    {resolution === 'ai' && (
                                        <span className="inline-flex items-center gap-1 text-[9px] font-bold px-1.5 py-0.5 rounded bg-status-success/10 text-status-success uppercase tracking-wider">
                                    ...
                                    {!resolution && (
                                        <div className="flex items-center gap-1 text-[10px] text-status-ai font-bold">
