...
function TimelineNode({
    ...
    const theme = (() => {
        if (status === 'done') return {
            bg: 'bg-status-success/10 dark:bg-status-success/15 border-status-success/30',
            dotBg: 'bg-status-success text-white',
            labelColor: 'text-foreground',
        }
        if (highlight) return {
            bg: 'bg-status-ai/10 dark:bg-status-ai/15 border-status-ai/40 ring-2 ring-ai/20',
            dotBg: 'bg-status-ai text-white',
            labelColor: 'text-foreground',
        }
