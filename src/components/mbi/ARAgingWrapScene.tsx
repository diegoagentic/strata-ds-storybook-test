...
export default function ARAgingWrapScene() {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="bg-status-success/5 border border-status-success/20 rounded-xl px-3 py-2 flex items-center gap-2">
            ...
            <div className="bg-status-ai/5 dark:bg-status-ai/10 border border-status-ai/30 rounded-xl p-3 flex items-start gap-2.5">
                <Mail className="h-4 w-4 text-status-ai shrink-0 mt-0.5" />
                <div className="text-xs flex-1">
            ...
            {!morningClosed ? (
                ...
                <div className="border border-status-success/30 bg-status-success/5 dark:bg-status-success/10 rounded-2xl p-4 flex items-center gap-3">
                    <div className="h-8 w-8 rounded-full bg-status-success/15 text-status-success flex items-center justify-center shrink-0">
                        <CheckCircle2 className="h-4 w-4" />
                    </div>
                    <div>
