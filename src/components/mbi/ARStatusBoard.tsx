...
export default function ARStatusBoard({ records, highlightedIds }: ARStatusBoardProps) {
    ...
    return (
        <div className="space-y-3">
            ...
            {/* Quick action toast */}
            {actionToast && (
                <div className="bg-status-success/10 dark:bg-status-success/15 border border-status-success/30 rounded-xl p-3 flex items-center gap-2 animate-in fade-in slide-in-from-top-2 duration-200">
                                    ...
                                    items.map(r => {
                                        ...
                                        return (
                                            <div key={r.id} className={`bg-zinc-50/50 dark:bg-zinc-800 border rounded-lg border-l-4 text-xs transition-all ${
                                                ...
                                                {r.collectionsHold && resolvedHolds.has(r.id) && (
                                                    <div className="px-2.5 py-1.5 bg-status-success/5 border-b border-status-success/20 flex items-center gap-1.5">
                                                        <Check className="h-2.5 w-2.5 text-status-success shrink-0" />
                                                        <span className="text-[9px] font-bold uppercase tracking-wider text-status-success">
                                                ...
                                                >
                                                    ...
                                                    {r.replyIntent && (
                                                        <div className="flex items-start gap-1 mt-1.5 px-1.5 py-1 bg-status-ai/10 rounded text-[9px] text-status-ai font-semibold leading-tight">
