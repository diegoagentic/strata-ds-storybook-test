 ...
 *            · text-status-ai for AI/parser accents · bg-primary for progress bar
 *
        ...
        <div className="bg-card dark:bg-zinc-800 border border-border rounded-2xl overflow-hidden">
            ...
            <div className="px-4 py-3 border-b border-border bg-muted/20">
                ...
                <div className="h-1.5 bg-muted rounded-full overflow-hidden">
                    <div
                        className={`h-full rounded-full transition-all duration-200 ${isComplete ? 'bg-status-success' : 'bg-status-ai'}`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 divide-y md:divide-y-0 md:divide-x divide-border">
                            ...
                            return (
                                <div
                                    ...
                                    className={`
                                        ...
                                        ${isActive ? 'bg-status-ai/10 text-status-ai' : ''}
                ...
                <div className="md:col-span-3 p-4">
                    ...
                    {isComplete && (
                        <div className="mt-3 flex items-center gap-2 text-xs text-status-success bg-status-success/5 border border-status-success/20 rounded-lg px-3 py-2 animate-in fade-in duration-300">
