                            ...
                            <div key={entry.spec.id} className="flex items-center gap-1 shrink-0">
                                <Comp
                                    ...
                                    className={`
                                        ...
                                        ${isCompleted ? 'text-status-success border-status-success/30 bg-status-success/5' : ''}
                                ...
                                {chipIdx < visibleSteps.length - 1 && (
                                    <div className={`h-px w-3 shrink-0 ${entry.originalIndex < activeStep ? 'bg-status-success/50' : 'bg-border'}`} />
                                )}
                            </div>
                        )
                    })}
