...
function OverviewStub() {
    return (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <StatCard value="4 → 1+1" label="Audit loops (collapsed)" accent="text-status-success" />
            <StatCard value="< 5 min" label="Quote validation turnaround" accent="text-zinc-900 dark:text-primary" />
            <StatCard value="2h → 12m" label="Per proposal PC effort" accent="text-status-success" />
        </div>
    )
}
