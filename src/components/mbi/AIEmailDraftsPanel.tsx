        ...
        <>
            <div className="bg-card dark:bg-zinc-800 border border-border rounded-2xl overflow-hidden">
                <div className="px-4 py-3 border-b border-border flex items-center gap-2">
                    <div className="h-7 w-7 rounded-lg bg-status-ai/10 text-status-ai flex items-center justify-center">
                ...
                {aiQuestion === 'visible' && (
                    <div className="px-4 py-3 border-b border-border bg-status-ai/5 dark:bg-status-ai/10 animate-in slide-in-from-top-2 duration-300">
                        <div className="flex items-start gap-2.5">
                            <div className="h-6 w-6 rounded-lg bg-status-ai/15 text-status-ai flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div className="divide-y divide-border">
                    {drafts.map(draft => {
                        ...
                        return (
                            <div key={draft.id} className={`px-4 py-3 ${draft.autoSent ? 'bg-status-success/5' : ''}`}>
                                {draft.autoSent ? (
                                    <div className="flex items-center gap-2 text-xs">
                                        <CheckCircle2 className="h-4 w-4 text-status-success shrink-0" />
                                        <div className="flex-1 min-w-0">
                                            <span className="font-semibold text-status-success">Auto-sent by Strata · delivered</span>
                                            <span className="text-muted-foreground ml-2">→ {draft.to}</span>
                                        </div>
                                        <span className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-status-success/15 text-status-success uppercase tracking-wider shrink-0">No action needed</span>
                                    </div>
                                ) : isSent ? (
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 justify-end">
                                            ...
                                            <button
                                                ...
                                                className="flex items-center gap-1 px-3 py-1 text-[10px] font-bold text-zinc-900 bg-primary rounded hover:opacity-90 transition-opacity"
                                            >
    ...
    return (
        ...
        >
            <div className="space-y-4">
                ...
                <section className="bg-status-ai/5 dark:bg-status-ai/10 border border-status-ai/30 rounded-xl p-3 space-y-2">
                    <div className="flex items-center gap-2">
                        <Wand2 className="h-3.5 w-3.5 text-status-ai" />
                        <span className="text-[10px] font-bold text-status-ai uppercase tracking-wider">Polish with AI</span>
                        {appliedPolish && (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-3 border-t border-border">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            onClick={handleSave}
                            disabled={!isDirty}
                            className="flex items-center gap-1.5 px-4 py-2 text-sm font-bold text-zinc-900 bg-primary rounded-lg hover:opacity-90 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed"
                        >
    ...
    return (
        <button
            ...
            className={`text-left px-3 py-2 rounded-lg border transition-colors ${
                active
                    ? 'bg-status-ai/15 border-status-ai/60 text-foreground'
                    : 'bg-card dark:bg-zinc-900 border-border hover:border-status-ai/40 hover:bg-status-ai/5'
            }`}
        >
