                ...
                <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-4 items-center">
                    ...
                    <div className="space-y-2">
                        ...
                        {AFTER_LOOPS.map((loop, i) => (
                            <div key={i} className={`border rounded-lg px-3 py-2 flex items-center gap-2 ${loop.isAI ? 'bg-status-ai/5 border-status-ai/30' : 'bg-primary/5 border-primary/30'}`}>
                                <div className={`h-6 w-6 rounded-full flex items-center justify-center shrink-0 ${loop.isAI ? 'bg-status-ai/10 text-status-ai' : 'bg-primary/10 text-zinc-900 dark:text-primary'}`}>
                        ...
                        <div className="flex items-center gap-1.5 text-[11px] text-status-success pt-1 font-semibold">
