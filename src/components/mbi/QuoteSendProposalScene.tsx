        ...
        <div className="space-y-4">
            ...
            {sent && (
                <FlowHandoff
                    ...
                    recapStats={[
                        { icon: <Clock className="h-4 w-4" />, value: '12 min', sub: 'vs 2h per proposal', accent: 'text-status-success' },
                        { icon: <Sparkles className="h-4 w-4" />, value: '4 → 1+1', sub: 'audit loops collapsed', accent: 'text-status-success' },
...
function SendBar({
    ...
    return (
        <div className={`px-4 py-3 border-t border-border flex items-center gap-3 ${
            sent ? 'bg-status-success/5 dark:bg-status-success/10' : 'bg-muted/10'
        }`}>
            <div className="flex-1 min-w-0">
                {sent && sentAt ? (
                    <div className="flex items-center gap-2 flex-wrap">
                        <div className="text-[11px] text-status-success font-semibold inline-flex items-center gap-1">
            ...
            <div className="flex items-center gap-2 shrink-0">
                ...
                {!sent && (
                    <button
                        onClick={onSend}
                        className="flex items-center gap-1.5 px-4 py-2 text-xs font-bold text-zinc-900 bg-primary rounded-xl hover:opacity-90 transition-opacity shadow-sm whitespace-nowrap"
                    >
                ...
                <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground">
                        <div className="text-right shrink-0">
                            ...
                            <div className="text-sm font-bold text-status-success">~12 min <span className="text-muted-foreground font-normal text-[10px]">was 2h</span></div>
                        </div>
                    </div>
                    {sent
...
function BudgetRow({
    ...
    const valueColor = tone === 'success' ? 'text-status-success' : tone === 'info' ? 'text-status-info' : 'text-foreground'
    return (
